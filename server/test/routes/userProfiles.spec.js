    ...
    it("should store user info and return info in response", (done) => {
      ...
      chai
        ...
        .end((err, res) => {
          ...
          res.body.should.have.property("location").eql("Some location");
          res.body.should.have.property("overview").eql("This is my overview");
    ...
    it("should return 200 status and success message if jwt id and param id match", (done) => {
      ...
      chai
        ...
        .end((err, res) => {
          ...
          res.body.should.have.property("success").eql("User Profile was updated");
          done();
        });
    });
  });
